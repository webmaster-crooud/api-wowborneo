...
export const destinationValidation = z.object({
	...
	description: z.string().max(1000, "Description of destination has max. 1000 character").optional().nullable(),
...
export const addDestinationValidation = z.object({
	body: z.object({
		destinations: z.array(destinationValidation).optional().nullable(),
	}),
});
