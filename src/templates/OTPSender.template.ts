...
export const OTPSenderTemplate = ({ firstName, lastName, otp, subject }: propsOTPSenderTemplate) => {
	const company = {
		name: "Wow Borneo",
		url: env.BASE_URL,
		address: {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <a href="${company.url}" class="button">Kunjungi Kami</a>
        </div>
        <div class="footer">
