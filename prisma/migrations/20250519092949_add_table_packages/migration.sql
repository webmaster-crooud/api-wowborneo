...
-- CreateTable
CREATE TABLE `package_cruises` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `cruiseId` VARCHAR(100) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `package_cruises` ADD CONSTRAINT `package_cruises_packageId_fkey` FOREIGN KEY (`packageId`) REFERENCES `packages`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `package_cruises` ADD CONSTRAINT `package_cruises_cruiseId_fkey` FOREIGN KEY (`cruiseId`) REFERENCES `river_cruise`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
