/*
  ...
  - A unique constraint covering the columns `[cruiseId,packageId]` on the table `package_cruises` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX `package_cruises_cruiseId_packageId_key` ON `package_cruises`(`cruiseId`, `packageId`);
