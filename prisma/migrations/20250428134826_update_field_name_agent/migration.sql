/*
  ...
  - You are about to drop the column `commissionLocal` on the `agents` table. All the data in the column will be lost.
  ...
  - Added the required column `commission_local` to the `agents` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `agents` DROP COLUMN `commissionLocal`,
    ADD COLUMN `commission_local` INTEGER NOT NULL,
